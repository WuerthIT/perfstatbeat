...
AIX performance metrics collected through the perfstat API and supplied in a form, that is mostly compatible with the upstream metricbeat system module.
